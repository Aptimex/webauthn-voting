...
func main() {
	...
	r.HandleFunc("/cast/begin", LoginRequired(BeginCast)).Methods("POST")
	r.HandleFunc("/cast/finish", LoginRequired(FinishCast)).Methods("POST")
	r.HandleFunc("/verify/begin", LoginRequired(BeginVerify)).Methods("POST")
	r.HandleFunc("/verify/finish", LoginRequired(FinishVerify)).Methods("POST")
